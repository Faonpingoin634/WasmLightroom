...
function loadImage(file) {
    ...
    reader.onload = (e) => {
        ...
        img.onload = () => {
            ...
            ['btn-original', 'btn-grayscale', 'btn-invert', 'btn-blur', 'btn-brightness', 'btn-export']
...
document.getElementById('btn-grayscale').addEventListener('click', () => applyWasmFilter('filter'));
document.getElementById('btn-invert').addEventListener('click',    () => applyWasmFilter('filter'));
document.getElementById('btn-blur').addEventListener('click',      () => applyWasmFilter('filter'));
document.getElementById('btn-brightness').addEventListener('click',() => applyWasmFilter('filter'));
...
container.addEventListener('dragover', (e) => { e.preventDefault(); container.style.borderColor = '#0d6efd'; });
container.addEventListener('dragleave', () => { container.style.borderColor = '#0f3460'; });
